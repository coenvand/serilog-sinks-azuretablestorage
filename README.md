# Serilog.Sinks.AzureTableStorage.NETStandard [![Build status](https://ci.appveyor.com/api/projects/status/bb9v4y9dguyn7w9a/branch/master?svg=true)](https://ci.appveyor.com/project/serilog/serilog-sinks-azuretablestorage/branch/master)
...
**Package** - [Serilog.Sinks.AzureTableStorage.NETStandard](https://www.nuget.org/packages/Serilog.Sinks.AzureTableStorage.NETStandard/) | **Platforms** - .NET Standard 2.0
